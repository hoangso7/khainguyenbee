...
const QRBeehiveDetail = () => {
      ...
      try {
        ...
        if (response.data?.beehive) {
          ...
          setEditFormData({
            ...
            species: beehiveData.species || 'Furva Vàng',
  ...
  const getHealthStatusIcon = (status) => {
    switch (status) {
      ...
      default: return '/static/icons/health/good.png';
    }
  };

  const healthStatusOptions = ['Tốt', 'Yếu'];
  const speciesOptions = ['Furva Vàng', 'Furva Đen'];
  ...
  const handleCancelEdit = () => {
    ...
    if (beehive) {
      setEditFormData({
        ...
        species: beehive.species || 'Furva Vàng',
        notes: beehive.notes || '',
      });
    }
  };
